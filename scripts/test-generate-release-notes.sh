...
assert_contains '<td rowspan="7"><img src="https://cdn.simpleicons.org/apple/808080"'
assert_contains 'alt="Homebrew logo"> <strong>Homebrew</strong>'
assert_contains '<code>brew install --cask neomacs-core/tap/neomacs</code>'

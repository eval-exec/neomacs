...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_tessellation(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    tile_size: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_water_drop(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    ripple_count: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_guilloche(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    curve_count: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_pixel_dust(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    dust_count: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_trefoil_knot(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    knot_size: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_quill_pen(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    trail_length: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_herringbone_pattern(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    tile_width: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_aurora_borealis(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    band_count: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_target_reticle(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    ring_count: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_feather(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    feather_count: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_plaid_pattern(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    band_width: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_stardust(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    particle_count: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_brick_wall(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    brick_width: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_compass_needle(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    needle_length: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_sine_wave(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    amplitude: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_galaxy(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    star_count: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_rotating_gear(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    gear_size: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_prism(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    ray_count: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_crosshatch_pattern(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    line_spacing: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_moth(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    moth_count: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_concentric_rings(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    ring_spacing: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_flame(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    particle_count: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_zigzag_pattern(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    amplitude: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_crystal(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    facet_count: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_moire_pattern(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    line_spacing: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_lightning(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    bolt_count: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_dot_matrix(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    dot_spacing: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_snowflake(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    count: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_wave_interference(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    wavelength: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_portal(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    radius: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_chevron_pattern(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    spacing: c_int,
...
#[cfg(feature = "winit-backend")]
#[no_mangle]
pub unsafe extern "C" fn neomacs_display_set_cursor_bubble(
    _handle: *mut NeomacsDisplay,
    enabled: c_int,
    r: c_int, g: c_int, b: c_int,
    count: c_int,

//! Combo: cl-define-setf-expander + marker + overlay + textprop + buflocal + narrow + undo.
//! Tests define-setf-expander with buffer state.

use crate::common::assert_oracle_parity;
use crate::common::return_if_neovm_enable_oracle_proptest_not_set;

#[test]
fn combo_cl_define_setf_expander_marker_overlay_textprop_buflocal_narrow_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

    let expect = expect_test::expect![[r#""ERR (void-function \\(setf\\ char-after\\))""#]];
    crate::common::assert_oracle_parity_expect(
        r#"(progn
  (let ((buf (generate-new-buffer "dse")))
...
#[test]
fn combo_cl_define_setf_expander_clone_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_define_setf_expander_multi_buffer_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

    let expect = expect_test::expect![[r#""OK t""#]];
    crate::common::assert_oracle_parity_expect(
        r#"(progn
  (let ((b1 (generate-new-buffer "de1"))
        (b2 (generate-new-buffer "de2")))
...
#[test]
fn combo_cl_define_setf_expander_setf_replace_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_define_setf_expander_multi_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

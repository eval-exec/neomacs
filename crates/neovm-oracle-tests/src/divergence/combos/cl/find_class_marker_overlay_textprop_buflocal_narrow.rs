//! Combo: cl-find-class + marker + overlay + textprop + buflocal + narrow + undo.
//! Tests find-class with buffer state.

use crate::common::assert_oracle_parity;
use crate::common::return_if_neovm_enable_oracle_proptest_not_set;

#[test]
fn combo_cl_find_class_marker_overlay_textprop_buflocal_narrow_undo() {
...
#[test]
fn combo_cl_find_class_clone_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_find_class_multi_buffer_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_find_class_setf_replace_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_find_class_multi_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

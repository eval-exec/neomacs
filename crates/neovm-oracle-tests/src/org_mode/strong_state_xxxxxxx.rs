//! Strong state-xxxxxxx oracle tests — extreme mutable state capture.
//!
...
#[test]
fn sxxxxxxx_element_parse_modify() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn sxxxxxxx_planning_repeaters() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn sxxxxxxx_timestamp_repeater() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn sxxxxxxx_hierarchy_contents() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn sxxxxxxx_entity_replacement() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn sxxxxxxx_structure_template() {
    return_if_neovm_enable_oracle_proptest_not_set!();

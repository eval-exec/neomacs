//! Strong edge-deep-3 oracle tests — boundary conditions.
//!
...
#[test]
fn ed3_empty_buffer_meta_return() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn ed3_deep_nesting_promote_demote() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn ed3_timestamp_inactive_time() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn ed3_block_multiple_languages() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
#[test]
fn ed3_drawer_multiple_properties() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn ed3_visibility_single_heading() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn ed3_structure_template_various() {
    return_if_neovm_enable_oracle_proptest_not_set!();

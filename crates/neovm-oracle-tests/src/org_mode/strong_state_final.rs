//! Strong state-final oracle tests — final mutable state capture.
//!
...
// ═══════════════════════════════════════════════════════════════════════
// State final: headline + todo + tags + priority after edit
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sf_headline_edit_all() {
...
// ═══════════════════════════════════════════════════════════════════════
// State final: property cycle
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sf_property_cycle() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State final: property inheritance
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sf_property_inherit() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State final: checkbox stats
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sf_checkbox_stats() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State final: element parse modify
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sf_element_parse_modify() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State final: export environment
// ═══════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════
// State final: planning repeaters
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sf_planning_repeaters() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect =
...
// ═══════════════════════════════════════════════════════════════════════
// State final: timestamp repeater
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sf_timestamp_repeater() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State final: block switches
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sf_block_switches() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State final: footnote markup
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sf_footnote_markup() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State final: hierarchy contents
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sf_hierarchy_contents() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State final: agenda entries
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sf_agenda_entries() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[r#""OK nil""#]];
    crate::common::assert_oracle_parity_expect(
        r##"(with-temp-buffer
...
// ═══════════════════════════════════════════════════════════════════════
// State final: colview format
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sf_colview_format() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State final: macro expansion
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sf_macro_expansion() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect =
...
// ═══════════════════════════════════════════════════════════════════════
// State final: entity replacement
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sf_entity_replacement() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State final: structure template
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sf_structure_template() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State final: refile targets
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sf_refile_targets() {
    return_if_neovm_enable_oracle_proptest_not_set!();

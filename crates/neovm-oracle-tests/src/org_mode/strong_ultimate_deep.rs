//! Strong ultimate-deep oracle tests — maximum coverage.
//!
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: full document lifecycle
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_full_lifecycle() {
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: property chain
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_property_chain() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: checkbox stats
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_checkbox_stats() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: planning repeaters
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_planning_repeaters() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: timestamp repeater
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_timestamp_repeater() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: block switches
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_block_switches() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: footnote markup
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_footnote_markup() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: hierarchy contents
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_hierarchy_contents() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: agenda entries
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_agenda_entries() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[r#""OK nil""#]];
    crate::common::assert_oracle_parity_expect(
        r##"(with-temp-buffer
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: macro expansion
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_macro_expansion() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect =
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: entity replacement
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_entity_replacement() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: structure template
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_structure_template() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: refile targets
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_refile_targets() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: deferred chain
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_deferred_chain() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: end of subtree
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_end_of_subtree() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: copy paste subtree
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_copy_paste_subtree() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: table formula alignment
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_table_formula_align() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: list with all features
// ═══════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════
// Ultimate: visibility all
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn ud_visibility_all() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[r#""ERR (wrong-number-of-arguments (0 . 0) 1)""#]];
    crate::common::assert_oracle_parity_expect(
        r##"(with-temp-buffer

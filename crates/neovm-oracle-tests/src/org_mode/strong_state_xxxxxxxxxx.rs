//! Strong state-xxxxxxxxxx oracle tests — extreme mutable state capture.
//!
...
#[test]
fn sxxxxxxxxxx_headline_edit_all() {
...
#[test]
fn sxxxxxxxxxx_property_inherit() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn sxxxxxxxxxx_element_parse_modify() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn sxxxxxxxxxx_planning_repeaters() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn sxxxxxxxxxx_timestamp_repeater() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn sxxxxxxxxxx_footnote_markup() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn sxxxxxxxxxx_hierarchy_contents() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn sxxxxxxxxxx_macro_expansion() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn sxxxxxxxxxx_entity_replacement() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn sxxxxxxxxxx_structure_template() {
    return_if_neovm_enable_oracle_proptest_not_set!();

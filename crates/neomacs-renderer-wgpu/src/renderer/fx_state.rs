...
pub(crate) struct ScrollMomentumEntry {
    ...
    pub(crate) started: neomacs_host_runtime::time::Instant,
...
pub(crate) struct TypingRippleState {
    pub(crate) active: Vec<(f32, f32, neomacs_host_runtime::time::Instant)>,
}
...
pub(crate) struct BorderTransitionState {
    ...
    pub(crate) transitions: Vec<(i64, bool, neomacs_host_runtime::time::Instant)>,
...
pub(crate) struct CursorTrailState {
    pub(crate) positions: Vec<(f32, f32, f32, f32, neomacs_host_runtime::time::Instant)>,
...
pub(crate) struct CursorWakeState {
    pub(crate) started: Option<neomacs_host_runtime::time::Instant>,
}

/// Cursor magnetism entries as (x, y, time).
#[derive(Default)]
pub(crate) struct CursorMagnetismState {
    pub(crate) entries: Vec<(f32, f32, neomacs_host_runtime::time::Instant)>,
}
...
pub(crate) struct CursorPendulumState {
    ...
    pub(crate) swing_start: Option<neomacs_host_runtime::time::Instant>,
}
...
pub(crate) struct CursorMetronomeState {
    pub(crate) last_x: f32,
    pub(crate) last_y: f32,
    pub(crate) tick_start: Option<neomacs_host_runtime::time::Instant>,
}

/// Cursor ripple ring state.
#[derive(Default)]
pub(crate) struct RippleRingState {
    pub(crate) start: Option<neomacs_host_runtime::time::Instant>,
    pub(crate) last_x: f32,
    pub(crate) last_y: f32,
}
...
pub(crate) struct BubbleState {
    pub(crate) spawn_time: Option<neomacs_host_runtime::time::Instant>,
    pub(crate) last_x: f32,
    pub(crate) last_y: f32,
}
...
pub(crate) struct EffectClocks {
    ...
    pub(crate) last_dim_tick: neomacs_host_runtime::time::Instant,
    /// Start time for pulse phase calculation
    pub(crate) cursor_pulse_start: neomacs_host_runtime::time::Instant,
    /// Search pulse start time
    pub(crate) search_pulse_start: neomacs_host_runtime::time::Instant,
    pub(crate) cursor_color_cycle_start: neomacs_host_runtime::time::Instant,
    pub(crate) focus_ring_start: neomacs_host_runtime::time::Instant,
    /// Last lightning bolt regeneration time
    pub(crate) lightning_bolt_last: neomacs_host_runtime::time::Instant,
    #[allow(dead_code)]
    pub(crate) rain_last_spawn: neomacs_host_runtime::time::Instant,
}
...
pub(crate) struct AmbientClocks {
    pub(crate) aurora_start: neomacs_host_runtime::time::Instant,
    /// Start time for elapsed time calculation (used by fancy border effects)
    pub(crate) render_start_time: neomacs_host_runtime::time::Instant,
}
...
impl RendererFrameEffects {
    ...
    pub fn spawn_ripple(&mut self, cx: f32, cy: f32) {
        self.fx
            .typing_ripple
            .active
            .push((cx, cy, neomacs_host_runtime::time::Instant::now()));
    }
    ...
    pub fn record_cursor_trail(&mut self, x: f32, y: f32, w: f32, h: f32, length: usize) {
        ...
        self.fx.cursor_trail.positions.push((
            x,
            y,
            w,
            h,

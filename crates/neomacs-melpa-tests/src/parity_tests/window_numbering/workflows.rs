...
fn enabling_the_mode_numbers_windows_and_installs_the_mode_line_entry() -> ParityBatchCase {
  ...
  (wn-test-reset))"##,
        expect![[
            r#"OK (:before (:mode nil :table nil :mode-line ("%e" mode-line-front-space mode-line-mule-info mode-line-client mode-line-modified mode-line-remote mode-line-window-dedicated mode-line-frame-identification mode-line-buffer-identification "   " mode-line-position #1=(project-mode-line project-mode-line-format) #2=(vc-mode vc-mode) "  " mode-line-modes mode-line-misc-info mode-line-end-spaces) :hooks (nil nil)) :source (:upstream-tree "616379219ab6bdcbc457313a16eb4ff9f63c40bc" :feature t :version "20160809.1810" :debug-ignored-errors ("^No window numbered .$")) :enabled (t t t t) :numbers (("*scratch*" 1)) :mode-line ("%e" (:eval (window-numbering-get-number-string)) mode-line-front-space mode-line-mule-info mode-line-client mode-line-modified mode-line-remote mode-line-window-dedicated mode-line-frame-identification mode-line-buffer-identification "   " mode-line-position #1# #2# "  " mode-line-modes mode-line-misc-info mode-line-end-spaces) :number-string #("1" 0 1 (face window-numbering-face)) :minibuffer-active nil :hooks ((window-numbering-update rfn-eshadow-setup-minibuffer minibuffer--regexp-setup minibuffer--nonselected-setup minibuffer-setup-on-screen-keyboard minibuffer-error-initialize minibuffer-history-isearch-setup minibuffer-history-initialize) (window-numbering-update window--adjust-process-windows)) :defcustoms (:auto-assign-0 ((choice (const :tag "Off" nil) (const :tag "On" t)) t) :position nil :face-spec nil))"#
        ]],
    )
}

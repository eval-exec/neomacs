...
#[test]
fn overlays_move_with_every_edit_shape_like_gnu() {
    crate::test_utils::init_test_tracing();
    // An insertion that touches no overlay boundary skips the detach-and-
    // reattach path, so every boundary case has to be checked against GNU:
    // an overlay starting or ending exactly at the edit, empty overlays,
    // front-advance and rear-advance in all four combinations, ordinary
    // insertion, `insert-before-markers' and deletion -- with a second
    // overlay elsewhere so the index is never empty.
    let result = crate::test_utils::runtime_startup_eval_one(
        r##"
(let ((rows nil))
  (dolist (ostart '(3 5 7))
    (dolist (olen '(0 2))
      (dolist (fa '(nil t))
        (dolist (ra '(nil t))
          (dolist (pos '(3 5 7))
            (dolist (op '(insert insert-before-markers delete))
              (push (list ostart olen fa ra pos op
                          (with-temp-buffer
                            (insert "0123456789")
                            (let ((o (make-overlay ostart (+ ostart olen) nil fa ra))
                                  (far (make-overlay 1 2)))
                              (goto-char pos)
                              (pcase op
                                ('insert (insert "XY"))
                                ('insert-before-markers (insert-before-markers "XY"))
                                ('delete (delete-char 1)))
                              (list (overlay-start o) (overlay-end o)
                                    (overlay-start far) (overlay-end far)))))
                    rows))))))
    )
  (nreverse rows))
        "##,
    ...
    assert_eq!(
        result,
        "OK ((3 0 nil nil 3 insert (3 3 1 2)) (3 0 nil nil 3 insert-before-markers (5 5 1 2)) (3 0 nil nil 3 delete (3 3 1 2)) (3 0 nil nil 5 insert (3 3 1 2)) (3 0 nil nil 5 insert-before-markers (3 3 1 2)) (3 0 nil nil 5 delete (3 3 1 2)) (3 0 nil nil 7 insert (3 3 1 2)) (3 0 nil nil 7 insert-before-markers (3 3 1 2)) (3 0 nil nil 7 delete (3 3 1 2)) (3 0 nil t 3 insert (3 5 1 2)) (3 0 nil t 3 insert-before-markers (5 5 1 2)) (3 0 nil t 3 delete (3 3 1 2)) (3 0 nil t 5 insert (3 3 1 2)) (3 0 nil t 5 insert-before-markers (3 3 1 2)) (3 0 nil t 5 delete (3 3 1 2)) (3 0 nil t 7 insert (3 3 1 2)) (3 0 nil t 7 insert-before-markers (3 3 1 2)) (3 0 nil t 7 delete (3 3 1 2)) (3 0 t nil 3 insert (3 3 1 2)) (3 0 t nil 3 insert-before-markers (5 5 1 2)) (3 0 t nil 3 delete (3 3 1 2)) (3 0 t nil 5 insert (3 3 1 2)) (3 0 t nil 5 insert-before-markers (3 3 1 2)) (3 0 t nil 5 delete (3 3 1 2)) (3 0 t nil 7 insert (3 3 1 2)) (3 0 t nil 7 insert-before-markers (3 3 1 2)) (3 0 t nil 7 delete (3 3 1 2)) (3 0 t t 3 insert (5 5 1 2)) (3 0 t t 3 insert-before-markers (5 5 1 2)) (3 0 t t 3 delete (3 3 1 2)) (3 0 t t 5 insert (3 3 1 2)) (3 0 t t 5 insert-before-markers (3 3 1 2)) (3 0 t t 5 delete (3 3 1 2)) (3 0 t t 7 insert (3 3 1 2)) (3 0 t t 7 insert-before-markers (3 3 1 2)) (3 0 t t 7 delete (3 3 1 2)) (3 2 nil nil 3 insert (3 7 1 2)) (3 2 nil nil 3 insert-before-markers (5 7 1 2)) (3 2 nil nil 3 delete (3 4 1 2)) (3 2 nil nil 5 insert (3 5 1 2)) (3 2 nil nil 5 insert-before-markers (3 7 1 2)) (3 2 nil nil 5 delete (3 5 1 2)) (3 2 nil nil 7 insert (3 5 1 2)) (3 2 nil nil 7 insert-before-markers (3 5 1 2)) (3 2 nil nil 7 delete (3 5 1 2)) (3 2 nil t 3 insert (3 7 1 2)) (3 2 nil t 3 insert-before-markers (5 7 1 2)) (3 2 nil t 3 delete (3 4 1 2)) (3 2 nil t 5 insert (3 7 1 2)) (3 2 nil t 5 insert-before-markers (3 7 1 2)) (3 2 nil t 5 delete (3 5 1 2)) (3 2 nil t 7 insert (3 5 1 2)) (3 2 nil t 7 insert-before-markers (3 5 1 2)) (3 2 nil t 7 delete (3 5 1 2)) (3 2 t nil 3 insert (5 7 1 2)) (3 2 t nil 3 insert-before-markers (5 7 1 2)) (3 2 t nil 3 delete (3 4 1 2)) (3 2 t nil 5 insert (3 5 1 2)) (3 2 t nil 5 insert-before-markers (3 7 1 2)) (3 2 t nil 5 delete (3 5 1 2)) (3 2 t nil 7 insert (3 5 1 2)) (3 2 t nil 7 insert-before-markers (3 5 1 2)) (3 2 t nil 7 delete (3 5 1 2)) (3 2 t t 3 insert (5 7 1 2)) (3 2 t t 3 insert-before-markers (5 7 1 2)) (3 2 t t 3 delete (3 4 1 2)) (3 2 t t 5 insert (3 7 1 2)) (3 2 t t 5 insert-before-markers (3 7 1 2)) (3 2 t t 5 delete (3 5 1 2)) (3 2 t t 7 insert (3 5 1 2)) (3 2 t t 7 insert-before-markers (3 5 1 2)) (3 2 t t 7 delete (3 5 1 2)) (5 0 nil nil 3 insert (7 7 1 2)) (5 0 nil nil 3 insert-before-markers (7 7 1 2)) (5 0 nil nil 3 delete (4 4 1 2)) (5 0 nil nil 5 insert (5 5 1 2)) (5 0 nil nil 5 insert-before-markers (7 7 1 2)) (5 0 nil nil 5 delete (5 5 1 2)) (5 0 nil nil 7 insert (5 5 1 2)) (5 0 nil nil 7 insert-before-markers (5 5 1 2)) (5 0 nil nil 7 delete (5 5 1 2)) (5 0 nil t 3 insert (7 7 1 2)) (5 0 nil t 3 insert-before-markers (7 7 1 2)) (5 0 nil t 3 delete (4 4 1 2)) (5 0 nil t 5 insert (5 7 1 2)) (5 0 nil t 5 insert-before-markers (7 7 1 2)) (5 0 nil t 5 delete (5 5 1 2)) (5 0 nil t 7 insert (5 5 1 2)) (5 0 nil t 7 insert-before-markers (5 5 1 2)) (5 0 nil t 7 delete (5 5 1 2)) (5 0 t nil 3 insert (7 7 1 2)) (5 0 t nil 3 insert-before-markers (7 7 1 2)) (5 0 t nil 3 delete (4 4 1 2)) (5 0 t nil 5 insert (5 5 1 2)) (5 0 t nil 5 insert-before-markers (7 7 1 2)) (5 0 t nil 5 delete (5 5 1 2)) (5 0 t nil 7 insert (5 5 1 2)) (5 0 t nil 7 insert-before-markers (5 5 1 2)) (5 0 t nil 7 delete (5 5 1 2)) (5 0 t t 3 insert (7 7 1 2)) (5 0 t t 3 insert-before-markers (7 7 1 2)) (5 0 t t 3 delete (4 4 1 2)) (5 0 t t 5 insert (7 7 1 2)) (5 0 t t 5 insert-before-markers (7 7 1 2)) (5 0 t t 5 delete (5 5 1 2)) (5 0 t t 7 insert (5 5 1 2)) (5 0 t t 7 insert-before-markers (5 5 1 2)) (5 0 t t 7 delete (5 5 1 2)) (5 2 nil nil 3 insert (7 9 1 2)) (5 2 nil nil 3 insert-before-markers (7 9 1 2)) (5 2 nil nil 3 delete (4 6 1 2)) (5 2 nil nil 5 insert (5 9 1 2)) (5 2 nil nil 5 insert-before-markers (7 9 1 2)) (5 2 nil nil 5 delete
8 1 2)) (7 2 nil nil 5 insert (9 11 1 2)) (7 2 nil nil 5 insert-before-markers (9 11 1 2)) (7 2 nil nil 5 delete (6 8 1 2)) (7 2 nil nil 7 insert (7 11 1 2)) (7 2 nil nil 7 insert-before-markers (9 11 1 2)) (7 2 nil nil 7 delete (7 8 1 2)) (7 2 nil t 3 insert (9 11 1 2)) (7 2 nil t 3 insert-before-markers (9 11 1 2)) (7 2 nil t 3 delete (6 8 1 2)) (7 2 nil t 5 insert (9 11 1 2)) (7 2 nil t 5 insert-before-markers (9 11 1 2)) (7 2 nil t 5 delete (6 8 1 2)) (7 2 nil t 7 insert (7 11 1 2)) (7 2 nil t 7 insert-before-markers (9 11 1 2)) (7 2 nil t 7 delete (7 8 1 2)) (7 2 t nil 3 insert (9 11 1 2)) (7 2 t nil 3 insert-before-markers (9 11 1 2)) (7 2 t nil 3 delete (6 8 1 2)) (7 2 t nil 5 insert (9 11 1 2)) (7 2 t nil 5 insert-before-markers (9 11 1 2)) (7 2 t nil 5 delete (6 8 1 2)) (7 2 t nil 7 insert (9 11 1 2)) (7 2 t nil 7 insert-before-markers (9 11 1 2)) (7 2 t nil 7 delete (7 8 1 2)) (7 2 t t 3 insert (9 11 1 2)) (7 2 t t 3 insert-before-markers (9 11 1 2)) (7 2 t t 3 delete (6 8 1 2)) (7 2 t t 5 insert (9 11 1 2)) (7 2 t t 5 insert-before-markers (9 11 1 2)) (7 2 t t 5 delete (6 8 1 2)) (7 2 t t 7 insert (9 11 1 2)) (7 2 t t 7 insert-before-markers (9 11 1 2)) (7 2 t t 7 delete (7 8 1 2)))"
    );
}

#[test]
fn an_insertion_inside_nested_overlays_grows_them_like_gnu() {
    crate::test_utils::init_test_tracing();
    // An overlay that strictly contains an insertion keeps its start, grows
    // its end and holds its place in the index -- no detach and reattach.
    // Nested and overlapping overlays, an empty one, ones that begin or end
    // exactly at the insertion, `insert-before-markers', and five successive
    // insertions inside one overlay all have to land where GNU puts them.
    let result = crate::test_utils::runtime_startup_eval_one(
        r##"
(let ((rows nil))
  (dolist (pos '(2 4 5 7 9))
    (dolist (op '(insert insert-before-markers))
      (push (list pos op
                  (with-temp-buffer
                    (insert "0123456789")
                    (let ((outer (make-overlay 1 11))
                          ...
                          (left (make-overlay 1 3))
                          (right (make-overlay 8 11)))
                      (goto-char pos)
                      (if (eq op 'insert) (insert "AB") (insert-before-markers "AB"))
  ...
  (push (with-temp-buffer
          (insert "0123456789")
          (let ((o (make-overlay 2 9)) (o2 (make-overlay 4 6)))
            (dotimes (k 5) (goto-char (+ 3 k)) (insert "z"))
...
#[test]
fn charset_list_holds_every_defined_charset_like_gnu() {
    crate::test_utils::init_test_tracing();
    // `charset-list' was nil: `define-charset-internal' and
    // `define-charset-alias' never added to it, and the five charsets GNU
    // defines in C before any Lisp runs were missing too. GNU conses each new
    // name on the front, unconditionally -- so defining the same alias twice
    // leaves two entries -- and its five built-ins sit at the end.
    let result = crate::test_utils::runtime_startup_eval_one(
        r##"
(list (length charset-list)
      (seq-take charset-list 3)
      (last charset-list 5)
      (= (length charset-list) (length (delete-dups (copy-sequence charset-list))))
      (and (memq 'koi8-r charset-list) t)
      (progn (define-charset-alias 'probe-alias 'koi8-r)
             (list (car charset-list) (length charset-list)))
      (progn (define-charset-alias 'probe-alias 'koi8-r)
             (length charset-list)))
        "##,
    );
